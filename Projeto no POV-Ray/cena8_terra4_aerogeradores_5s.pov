...
#declare Camera_7 = camera {/*ultra_wide_angle*/ angle 50+MoveA   //praia vista de frente
                            ...
                            look_at   <-1035,5, -20>}                                                                                    
//___________________________________________________________________________________
#declare MoveZ = 20*clock;
#declare MoveX = 250*clock;
#declare MoveXX = 100*clock;

#declare Camera_8 = camera {/*ultra_wide_angle*/ angle 0   //praia vista de frente
                            location <-950+MoveXX,10,60>
                            right     x*image_width/image_height
                            look_at   <-960-MoveX,8, 0>}                                                                                    
//___________________________________________________________________________________
