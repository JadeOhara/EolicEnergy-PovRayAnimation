...
#declare Camera_6 = camera {/*ultra_wide_angle*/ angle 100   //posição gerar imagens amanhecer
                            ...
                            look_at   <-300, 6, 700>}      
//___________________________________________________________________________________ 
#declare MoveX = 200*clock;
#declare MoveXX = 30*clock;
#declare MoveZ = 40*clock; 

#declare Camera_7 = camera {/*ultra_wide_angle*/ angle 0  //aerogeradores terra camera
                            location   < -930-MoveX, 15,30+MoveZ>
                            right     x*image_width/image_height
                            look_at   <-1010-MoveXX,10, -30>}                                                                                    
//___________________________________________________________________________________
...
plane{<0,1,0>,1 hollow
       texture{ pigment{ bozo turbulence 0.92
                       ...
                       rotate -40*x 
                       rotate -4.66*x*clock //VENTO NAS NÚVENS   
     ...
     #while (  Nr < End)
        sphere { < 0, 0, 0>,0.5
                texture { pigment { color White } finish {ambient 0.55 } }
                 ...
                 rotate z*-360*clock*2.66  //GIRAR TURBINAS
               }
     #declare Nr = Nr + 1;
     #end 
   }
