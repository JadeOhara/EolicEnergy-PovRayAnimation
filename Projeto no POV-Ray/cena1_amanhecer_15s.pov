...
#declare Camera_6 = camera {/*ultra_wide_angle*/ angle 100   //posição gerar imagens amanhecer
                            ...
                            look_at   <-300, 6, 700>}      
//___________________________________________________________________________________ 
#declare Camera_7 = camera {/*ultra_wide_angle*/ angle 120   //amanhecer
                            location   < 0, 10000,0>
                            right     x*image_width/image_height
                            look_at   <-200, 0, 1000>}                                                                                    
//___________________________________________________________________________________
...
light_source{ <-1000, 30000, 250000> 
              color Yellow
                       //___________________ANIMAÇÃO_______________________   
                        
                       rotate -3*x*clock //AMANHECER  
...
plane{<0,1,0>,1 hollow
       texture{ pigment{ bozo turbulence 0.92
                       ...
                       rotate -10*x*clock //VENTO NAS NÚVENS  
...
plane{<0,1,0>,1 hollow 
       texture{ pigment{ bozo turbulence 0.92
                       ...
                       rotate -12*x*clock //VENTO NAS NÚVENS  
   ...
   union{ 
     ...
     #while (  Nr < End)
        sphere { < 0, 0, 0>,0.5
                 ...
                 rotate z*-360*clock*3  //GIRAR TURBINAS
               }
     #declare Nr = Nr + 1;
     #end 
   }
